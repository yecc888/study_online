...
class UserAskAdmin(object):
    list_display = ['mobile', 'name', 'course_name', 'add_time']
    list_filter = ['mobile', 'name', 'course_name']
    search_fields = ['mobile', 'name', 'course_name', 'add_time']
